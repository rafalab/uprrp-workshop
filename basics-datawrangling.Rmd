...
Suppose it is of interest to compute the average height of males and females in the `heights` data. To do this, we need to split the data into males and females, and then compute the average. The functions `group_by` and `summarize` can be use to achieve this
